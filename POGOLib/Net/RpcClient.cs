...
namespace POGOLib.Net
{
    public class RpcClient : IDisposable
    {
        ...
        /// <returns></returns>
        public RequestEnvelope GetRequestEnvelope(Request request)
        {
        ...
        public ByteString SendRemoteProcedureCall(Request request)
        {
            ...
            {
                using (var response = _httpClient.PostAsync(_requestUrl ?? Constants.ApiUrl, requestData).Result) //this exploded
                {
